...
const ReceiptApp = () => {
  ...
  const totalAmount = 
    parseFloat(formData.fee || 0) - parseFloat(formData.discount || 0) + 
    parseFloat(formData.penalties || 0) + parseFloat(formData.others || 0);
            ...
            <div className="bg-slate-100 px-6 py-2 rounded-md">
              <table className="w-full">
                ...
                <tr className="border-b text-slate-500">
                  ...
                  <td className="py-4">Rs:{formData.discount}</td>
                </tr>
                <tr className="border-b text-slate-500">
                  <td className="py-4">Penalties</td>
                  <td className="py-4">Rs:{formData.penalties}</td>
                </tr>
                <tr className="border-b text-slate-500">
                  <td className="py-4">Others</td>
                  <td className="py-4">Rs:{formData.others}</td>
                </tr>
                <tr className="font-bold text-slate-700">
                  <td className="py-4">Total Amount to be Paid</td>
                  <td className="py-4">Rs:{totalAmount.toFixed(2)}</td>
                </tr>
              </table>
            </div>
            <hr className="my-6" />
